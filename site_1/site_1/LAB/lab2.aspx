<%@ Page Title="" Language="C#" MasterPageFile="~/LAB/lab.Master" AutoEventWireup="true" CodeBehind="lab2.aspx.cs" Inherits="site_1.LAB.lab2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Table ID="Table1" runat="server" CellPadding="10" CellSpacing="10" CssClass="RegistrationCentered">
        ...
        <asp:TableRow>
            <asp:TableCell ColumnSpan="2" CssClass="text-center">Already have an account?<a href="../login.aspx">../login.aspx</a></asp:TableCell>
        </asp:TableRow>
